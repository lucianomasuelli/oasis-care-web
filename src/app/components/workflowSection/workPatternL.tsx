...
export default function WorkPatternL(props: {
  ...
  return (
    <div className="w-[100vw] sm:w-[80vw] sm:h-[35vh] h-[37vh] min-h-[300px] overflow-hidden rounded-r-[200px] -mt-5 relative">
      <svg width="100%" height="100%">
        <rect x="0" y="0" width="100%" height="100%" fill={props.color}></rect>
      </svg>
      <div className="absolute inset-0 flex flex-col items-left justify-center md:ml-[30%] ml-[20%] w-[60%] ">
