...
export default function Header({
  ...
  const liStyle =
    "hover:border-[5px] border-[5px] border-transparent transition-transform  hover:-translate-y-1 hover:shadow-xl hover:border-b-white  duration-200  py-2 px-6";
  ...
  return (
    <header className="flex flex-row w-full sm:h-auto h-auto items-center sm:justify-center justify-between z-50 mr-4 overflow-hidden ">
      ...
      <ul className="sm:flex flex-row items-center justify-center lg:gap-10  font-medium text-white lg:text-lg sm:text-md hidden overflow-hidden ">
        <li className={liStyle}>
          <a href="#flujo" onClick={(e) => handleClick(e, "flujo")}>
            Flujo
          </a>
        </li>
        <li className={liStyle}>
      ...
      <button className=" group sm:hidden " onClick={() => setOpen(!open)}>
        ...
        {/* menu */}
        <div className="flex  align-middle justify-center overflow-hidden">
          <ul
            className={`${
