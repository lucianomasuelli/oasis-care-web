...
export default function Nosotros() {
  return (
    <div
      className="h-fit overflow-y-visible sm:mt-20 mt-10 sm:mb-20 "
      id="nosotros"
    >
      <div
      ...
      >
        ...
        <Image
          ...
          width={500}
          height={1000}
          className="object-cover self-center justify-center w-[40vw] h-[50vh] relative z-20 mt-10 sm:border-8 border-4 border-background-500 hidden sm:block rounded-bl-[50px] "
        />
        ...
        {/*Mobile image*/}
          <Image
            ...
            width={1000}
            height={500}
            className="object-contain  z-20 border-4 border-background-500 my-5 relative rounded-tr-[50px] rounded-bl-[50px] sm:hidden "
          />
          <Image
            src="/nosotros3.jpg"
            alt="nos3"
          ...
          />
           {/* <Image
            ...
            width={3024}
            height={4032}
            className="object-contain  z-20 border-4 border-background-500 my-5 relative rounded-tr-[50px] rounded-bl-[50px] "
          />  */}
      </div>
    </div>
  );
